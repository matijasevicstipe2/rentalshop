...
import hr.matijasevic.rentalshop.security.domain.Authority;
import hr.matijasevic.rentalshop.security.domain.User;
import hr.matijasevic.rentalshop.security.user.ApplicationUser;
import hr.matijasevic.rentalshop.security.user.UserAuthentication;
